...
public class CommunityInteractionController {
 ...
 @Operation(summary="게시글 좋아요") @ApiResponse(responseCode="204",description="좋아요 성공") @ApiResponse(responseCode="409",description="중복 좋아요")
 ...
 @Operation(summary="게시글 좋아요 취소") @ApiResponse(responseCode="204",description="취소 성공")
 ...
 @Operation(summary="관심 게시글 저장") @ApiResponse(responseCode="204",description="저장 성공") @ApiResponse(responseCode="409",description="중복 저장")
 ...
 @Operation(summary="관심 게시글 저장 해제") @ApiResponse(responseCode="204",description="해제 성공")
 ...
 @Operation(summary="내가 저장한 게시글 조회") @ApiResponse(responseCode="200",description="조회 성공")
 ...
 @Operation(summary="댓글 목록 조회",description="삭제된 댓글을 포함해 댓글과 1단계 대댓글을 조회합니다.") @ApiResponse(responseCode="200",description="조회 성공")
 ...
 @Operation(summary="댓글 또는 대댓글 작성",description="parentId가 있으면 1단계 대댓글을 작성합니다.") @ApiResponse(responseCode="201",description="작성 성공") @ApiResponse(responseCode="400",description="2단계 초과 대댓글")
 ...
 @Operation(summary="댓글 삭제",description="댓글 트리 유지를 위해 소프트 삭제합니다.") @ApiResponse(responseCode="204",description="삭제 성공") @ApiResponse(responseCode="403",description="작성자 권한 없음")
 ...
 @Operation(summary="대상 신고",description="게시글·댓글·채팅 메시지·사용자를 신고합니다.") @ApiResponse(responseCode="201",description="신고 접수") @ApiResponse(responseCode="409",description="중복 신고")
